...
import {EDIT_THIS_WEEK, EDIT_NEXT_WEEK, CHECK_THIS_WEEK, CHECK_NEXT_WEEK, PUSH_TO_THIS_WEEK, PUSH_TO_NEXT_WEEK, CHANGE_REPORT_DATE, ADD_PROJECT, CHANGE_CURRENT_PROJECT, UPDATE_CURRENT_PROJECT} from './actions'
...
const editReport = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case UPDATE_CURRENT_PROJECT:
      return state.updateIn(['projects', state.get('currentProject')], val => Object.assign({}, val, value))
    default:
      return state
  }
}
